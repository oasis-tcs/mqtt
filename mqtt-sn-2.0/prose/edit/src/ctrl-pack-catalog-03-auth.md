...
The values for the Authentication Reason Code field are shown in [sec](#reason-code). «<mark title="Requirement MQTT-SN-3.3.3-1"><a name="MQTT-SN-3.3.3-1"></a>The sender of the AUTH Packet MUST use one of the Reason Codes shown as applicable to the AUTH packet</mark>»[MQTT‑SN‑3.3.3‑1](#tab-MQTT-SN-3.3.3-1).
