...
The UNSUBACK Reason Codes are shown in [sec](#reason-code). «<mark title="Requirement MQTT-SN-3.10.3-1"><a name="MQTT-SN-3.10.3-1"></a>The Server sending the UNSUBACK Packet MUST use one of the UNSUBACK Reason Codes</mark>»[MQTT‑SN‑3.10.3‑1](#tab-MQTT-SN-3.10.3-1).
